...
#        self.w.setLayout(layout)
        ...
        self.Trace_grid.addWidget(Trace_index_Slider,               2, 0, 1, 3)
        self.Trace_grid.addWidget(self.Trace_index_Slider_Edit,     2, 1, 1, 3)
        self.Trace_grid.addWidget(self.traceSlider,                 3, 0, 1, 3)        
        self.Trace_grid.addWidget(self.traceindex,                  4, 0, 1, 1)
        self.Trace_grid.addWidget(self.traceindexEdit,              4, 1, 1, 2)
...
#        header = "Traces"+"\t"+"Good(1)_bad(-1)"+"\t"+"Threshold"+"\t"+"Green_minX"+"\t"+"Green_maxX"+"\t"+"Red_minX"+"\t"+"Red_maxX"+"\t"+"Signal2noise"+"\t"+"Intensity Green"+"\t"+"Step (colors)"
        header = "Traces"+"    "+"Good(1)_bad(-1)"+"    "+"Threshold"+"    "+"Green_minX"+"    "+"Green_maxX"+"    "+"Red_minX"+"    "+"Red_maxX"+"    "+"Signal2noise"+"    "+"Intensity_Green"+"    "+"Step_(colors)"+"    "+"Weber_contrast_(signal-bkg)/bkg"
